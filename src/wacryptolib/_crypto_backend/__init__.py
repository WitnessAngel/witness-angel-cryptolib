...
if use_fallback_backend :
    ...
    PATCHABLE_HASH_ALGOS = ["SHA1", "MD5", "SHA512", "SHA256", "SHA512", "SHA3_256", "SHA3_512"]  # Must be bigger than SUPPORTED_HASH_ALGOS of wacryptolib
...
from .pycryptodome import encrypt_via_aes_cbc, decrypt_via_aes_cbc, encrypt_via_aes_eax, decrypt_via_aes_eax, encrypt_via_chacha20_poly1305, decrypt_via_chacha20_poly1305, build_rsa_oaep_cipher, build_aes_cbc_cipher, build_aes_eax_cipher, build_chacha20_poly1305_cipher, AES_BLOCK_SIZE
