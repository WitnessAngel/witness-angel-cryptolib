...
def test_find_authdevices_in_macosx_system_profiler_data():
    ...
    plist_output = [{'_SPCommandLineArguments': ['/usr/sbin/system_profiler',
                                  '-nospawn',
                                  '-xml',
                                  'SPUSBDataType',
                                  '-detailLevel',
      ...
      '_detailLevel': -1,
      '_items': [{'_name': 'USB31Bus', 'host_controller': 'AppleT8103USBXHCI'},
                 {'_items': [{'Media': [{'Logical Unit': 0,
                                         'USB Interface': 0,
                                         '_name': 'Voyager',
                                         'bsd_name': 'disk4',
                                         ...
                                         'volumes': [{'_name': 'Install macOS '
                                                               'Monterey',
                                                      'bsd_name': 'disk4s1',
                                                      'file_system': 'Journaled '
                                                                     'HFS+',
                                                      'free_space': '2,06 GB',
      ...
      '_properties': {'1284DeviceID': {'_order': '13'},
                      '_name': {'_isColumn': 'YES',
